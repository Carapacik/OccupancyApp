...
{
    public class OccupancyUtilsTest
    {
        [Fact]
        public void GetAllOccupancyIntervals_ConsecutiveIntervals_CorrectBorders()
        {
            ...
            var result = OccupancyUtils.GetAllOccupancyIntervals(roomTypeSettingsList);
        ...
        public void GetOccResultInCorrectForm_ConsecutiveIntervals_CorrectInputList()
        {
            ...
            var occupancyResult = OccupancyUtils.GetAllOccupancyIntervals(roomTypeSettingsList);

            var result = OccupancyUtils.GetOccResultInCorrectForm(roomTypeSettingsList, occupancyResult);
